...
export function Drop(p: IconProps) {
  return (
    <svg {...base} {...p}>
      <path d="M12 2.7s6 6.4 6 10.6a6 6 0 1 1-12 0C6 9.1 12 2.7 12 2.7z" />
...
export function Star(p: IconProps) {
  return (
    <svg width={20} height={20} viewBox="0 0 24 24" fill="currentColor" {...p}>
      <path d="M12 17.3 6.18 21l1.64-6.81L2 9.6l6.92-.55L12 2.5l3.08 6.55 6.92.55-5.82 4.59L17.82 21z" />
    </svg>
  );
}

export const iconMap = { feather: Feather, shield: Shield, leaf: Leaf, award: Award } as const;
